...
${OBJECTDIR}/API_Leitura/API_Leitura.o: API_Leitura/API_Leitura.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/API_Leitura/API_Leitura.o API_Leitura/API_Leitura.c

${OBJECTDIR}/API_Leitura/API_Utils.o: API_Leitura/API_Utils.c
	${MKDIR} -p ${OBJECTDIR}/API_Leitura
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/API_Leitura/API_Utils.o API_Leitura/API_Utils.c

${OBJECTDIR}/MyLibs/extras.o: MyLibs/extras.c
	${MKDIR} -p ${OBJECTDIR}/MyLibs
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MyLibs/extras.o MyLibs/extras.c

${OBJECTDIR}/MyLibs/gestao_encomendas.o: MyLibs/gestao_encomendas.c
	${MKDIR} -p ${OBJECTDIR}/MyLibs
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MyLibs/gestao_encomendas.o MyLibs/gestao_encomendas.c

${OBJECTDIR}/MyLibs/gestao_faturas.o: MyLibs/gestao_faturas.c
	${MKDIR} -p ${OBJECTDIR}/MyLibs
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MyLibs/gestao_faturas.o MyLibs/gestao_faturas.c

${OBJECTDIR}/MyLibs/gestao_precos.o: MyLibs/gestao_precos.c
	${MKDIR} -p ${OBJECTDIR}/MyLibs
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MyLibs/gestao_precos.o MyLibs/gestao_precos.c

${OBJECTDIR}/MyLibs/gestao_utilizadores.o: MyLibs/gestao_utilizadores.c
	${MKDIR} -p ${OBJECTDIR}/MyLibs
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MyLibs/gestao_utilizadores.o MyLibs/gestao_utilizadores.c

${OBJECTDIR}/MyLibs/menus.o: MyLibs/menus.c
	${MKDIR} -p ${OBJECTDIR}/MyLibs
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MyLibs/menus.o MyLibs/menus.c
