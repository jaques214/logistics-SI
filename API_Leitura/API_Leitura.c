...
#include "API_Utils.h"
     ...
     */
    #define MSG_LEITURA_INT_GAMA_INVALIDA "O numero que introduziu e invalido. Introduza um valor entre %d e %d.\n"
/**
     * @brief Mensagem a mostrar ao utilizador caso o número inteiro introduzido 
     *  nao respeite o limite inicial e final definido.
     */
     ...
     * 
     * @param value - Apontador para a frase lida.
     * @param size - Tamanho máximo da frase a ser lida. @warning: O tamanho 
